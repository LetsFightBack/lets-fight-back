      ...
      <div className="form__leftFields">
        ...
        <div className="form__field">
          ...
          >
            ...
            <option value="Technology - Backend Engineer">Technology - Backend Engineer</option>
            ...
            <option value="Software Development - Test">Software Development - Test</option>
            <option value="Quality Analyst">Quality Analyst</option>
            <option value="Finance and Risk Management">Finance and Risk Management</option>
            <option value="Accounting & Reconciliation">Accounting & Reconciliation</option>
            <option value="Product and Strategy">Product and Strategy</option>
            ...
            <option value="Teacher/Coach ( Educator)">Teacher/Coach ( Educator)</option>
            <option value="Security / Quality Management">Security / Quality Management</option>
            ...
            <option value="R&D / New Product Development">R&D / New Product Development</option>
