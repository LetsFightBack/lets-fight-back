...
export default function Dashboard() {
  ...
  const SENT_FOR_VERIFICATION_MESSAGE =
    "Sit back and relax, your details have been sent for verification!";

  const VERIFIED_MESSAGE =
    "Congratulations, you're now officially verified and ready to dive into the ocean of excellent profiles waiting for you!";
      ...
      <Container className="w-75">
        <Form onSubmit={handleSubmit}>
          ...
          <Form.Group>
            ...
            <Form.Control type="email" name="email" value={userDetail.email} disabled />
          </Form.Group>
          <br />
          <Form.Group>
          ...
          {!getFormStatusFromVerificationStatus(verificationStatus) && (
