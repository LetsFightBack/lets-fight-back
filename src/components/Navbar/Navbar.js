...
export default function Appbar() {
    ...
    return(
      <Navbar bg="light" variant="light" class="shadow-sm p-3 mb-5 bg-white rounded">
      <Container>
        <Navbar.Brand href="/">
        <img
              src="/logo.svg"
        ...
        <Nav>
        { isLoggedIn ? <Dropdown/> :<Nav.Link href="/login">Login</Nav.Link> }
        </Nav>
      </Container>
    </Navbar>
    );
...
function Dropdown() {
    return(
        ...
        <span>
            <img alt="user icon" width="40" height="40" className="d-inline-block align-center" src="user-icon.svg"/>
        </span>
    }>
